...
public class Test {
	...
	static class Options {
		public boolean abbreviations = true;
		...
		public boolean typographicSmarts = true;
		...
		public boolean emojiShortcuts = true;
...
//				dataSet.set(EmojiExtension.USE_IMAGE_TYPE, true);
			} else {
...
//			dataSet.set(Parser.LISTS_LOOSE_ON_PREV_LOOSE_ITEM, true);
			if (options.tables && options.renderTablesGFM) {
				dataSet.set(TablesExtension.COLUMN_SPANS, false).set(TablesExtension.MIN_HEADER_ROWS, 1)
